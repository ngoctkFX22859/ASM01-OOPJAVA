...
public class asm2 {
    ...
    public static final String AUTHOR = "FX22859";
    ...
    public static void addCustomers() {
        ...
        customerId = sc.next();
        while (customerId.length() != 12 || !User.isFirstThreeDigitsValid(customerId) || customerId.matches(".*[a-zA-Z].*")) {
            System.out.println(
    ...
    public static void addAccountForCustomer() {
        ...
        for (Customer customer : bank.getCustomers()) {
            ...
            while (isExistedAccount) {
                ...
                System.out.println("Nhập lại số TK: ");
                accNumbers = sc.next();
    ...
    private static void findByCCCD() {
        Scanner sc = new Scanner(System.in);
        System.out.println("Vui lòng nhập lại số CCCD cần tìm");
        String cusId = sc.nextLine();
        boolean found = false;
        for (Customer customer : bank.getCustomers()) {
            if (customer.getCustomerID().contains(cusId)) {
                customer.displayInformation();
                found = true;
            }
        }
    ...
    private static void findByName() {
        Scanner sc = new Scanner(System.in);
        System.out.println("Vui lòng nhập lại tên cần tìm");
